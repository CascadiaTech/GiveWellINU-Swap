const abi = JSON.stringify([
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_rewardPerDay', type: 'uint256' },
    ],
  ...
  {
    inputs: [{ internalType: 'bool', name: '_bEnabled', type: 'bool' }],
    name: 'setEnableHarvest',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_rewardPerDay', type: 'uint256' }],
    name: 'setTokenRewardPerDay',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{ internalType: 'uint256[]', name: 'tokenIdList', type: 'uint256[]' }],
    name: 'unstake',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
    ...
    outputs: [
      {
        ...
        internalType: 'struct AnimeVerseStaking.UserInfo',
        name: '',
        type: 'tuple',
      },
    ],
...
export const NFTStakingAbiObject = JSON.parse(abi)
