const abi = JSON.stringify([
  {
    inputs: [
      { internalType: 'address', name: '_animeToken', type: 'address' },
      { internalType: 'address', name: '_feeAddress', type: 'address' },
      { internalType: 'uint256', name: '_animePerBlock', type: 'uint256' },
    ],
  ...
  {
    inputs: [],
    name: 'MAXIMUM_WITHDRAW_FEE_RATE',
    outputs: [{ internalType: 'uint16', name: '', type: 'uint16' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_lockupDuration', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'accAnimePerShare', type: 'uint256' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_animePerBlock', type: 'uint256' }],
...
export const StakingAbiObject = JSON.parse(abi)
